...
base_url='https://nfc.ai/'
mcp_uri='mcp/'
api_url=f'{base_url}{mcp_uri}'
...
root_path = '/hurricane-agent/'
daily_ingest_sql_path = f'{root_path}docs/daily_ingest.sql'
daily_prompt_path = f'{root_path}docs/daily_report_ingest_prompt.txt'
fluids_url = 'https://fluids.ai/'
wp_create_post_url=f'{fluids_url}wp-json/wp/v2/posts'
gpt_model = 'gpt-oss-120b-F16.gguf'
agent_log_path = f'{root_path}/logs'
